//TODOs
//Double clicks make errors
//Make possible to click on colum, and piece falls to position
//Better styling and animation
        ...
        (function (index) {
            ...
            squares[i].onclick = function(){
                ...
                //if (squares[index + 7].classList.contains('taken') && !(squares[index].classList.contains('taken'))) {
                    ...
                    //if the square below is not taken, cant play here
...
function checkBoard() {
    //make const showing all winning arrays
    const winningArrays = [
    ...
    for (let y = 0; y < winningArrays.length; y++) {
        ...
        // now check those arrays to see if they all have player-one class
        if (
